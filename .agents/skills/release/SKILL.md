...
name: release
description: >
  Coordinate a full Agilo release across engineering verification, npm,
...
Run the full Agilo maintainer release workflow, not just an npm publish.
...
7. If running through Agilo, you have issue context for status updates and follow-up task creation.
...
Agilo now uses a commit-driven release model:
...
- release summary in Agilo issue context
