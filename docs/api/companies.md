...
Manage companies within your Agilo instance.
...
Company logo uploads use the normal Agilo attachment size limit.
...
| `logoUrl` | string | Optional Agilo asset content path for the stored logo image |
