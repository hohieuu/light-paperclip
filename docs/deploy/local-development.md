...
summary: Set up Agilo for local development
---

Run Agilo locally with zero external dependencies.
...
No Docker or external database required. Agilo uses embedded PostgreSQL automatically.
