...
This document describes how `@agilo/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Agilo logs/transcript parsing
