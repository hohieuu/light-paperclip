...
Use when:
- You want Agilo to run Pi (the AI coding agent) locally as the agent runtime
...
- Agilo requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/agilos/ and resumed with --session.
