import type { PluginLauncherRegistration } from "@agilo/plugin-sdk";

export const PLUGIN_ID = "agilo-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".agilo-kitchen-sink-demo.txt",
} as const;
