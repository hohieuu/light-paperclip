...
const manifest: AgiloPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Agilo plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Agilo",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Agilo domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
