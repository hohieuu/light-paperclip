/**
 * `definePlugin` — the top-level helper for authoring a Agilo plugin.
 *
...
// ---------------------------------------------------------------------------
// AgiloPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `AgiloPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@agilo/plugin-sdk";
