/**
 * `@agilo/plugin-sdk/ui` — Agilo plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@agilo/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@agilo/plugin-sdk/ui";
 *
