...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AgiloPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Agilo host.
 *
...
export interface AgiloPluginManifestV1 {
   ...
   */
  minimumAgiloVersion?: PluginMinimumHostVersion;
