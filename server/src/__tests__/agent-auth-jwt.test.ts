...
describe("agent local JWT", () => {
  const secretEnv = "AGILO_AGENT_JWT_SECRET";
  const ttlEnv = "AGILO_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "AGILO_AGENT_JWT_ISSUER";
  const audienceEnv = "AGILO_AGENT_JWT_AUDIENCE";
