...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@agilo/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: AgiloPluginManifestV1, pluginDbId?: string): void;
