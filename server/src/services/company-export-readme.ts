 ...
 */
import type { CompanyPortabilityManifest } from "@agilo/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Agilo](https://agilo.tech)");
  lines.push("");
