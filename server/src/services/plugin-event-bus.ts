/**
 * PluginEventBus — typed in-process event bus for the Agilo plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@agilo/shared";
import type { PluginEvent, EventFilter } from "@agilo/plugin-sdk";
