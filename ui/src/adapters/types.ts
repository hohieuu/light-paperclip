...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@agilo/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@agilo/adapter-utils").TranscriptEntry[];
