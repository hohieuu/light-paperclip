...
export const DISMISSED_KEY = "agilo:inbox:dismissed";
export const READ_ITEMS_KEY = "agilo:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "agilo:inbox:last-tab";
