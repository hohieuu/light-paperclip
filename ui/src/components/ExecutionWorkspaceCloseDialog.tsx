...
import type { ExecutionWorkspace } from "@agilo/shared";
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="break-words">
            ...
            artifacts. Agilo keeps the workspace record and issue history, but removes it from active workspace views.
          </DialogDescription>
        </DialogHeader>
