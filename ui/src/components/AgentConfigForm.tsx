...
import { AGENT_ADAPTER_TYPES } from "@agilo/shared";
import type {
  Agent,
...
// Canonical type lives in @agilo/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@agilo/adapter-utils";
import type { CreateConfigValues } from "@agilo/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        AGILO_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
