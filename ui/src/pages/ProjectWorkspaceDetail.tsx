...
import { isUuidLike, type ProjectWorkspace } from "@agilo/shared";
...
const SOURCE_TYPE_OPTIONS: Array<{ value: ProjectWorkspaceSourceType; label: string; description: string }> = [
  { value: "local_path", label: "Local git checkout", description: "A local path Agilo can use directly." },
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-border bg-card p-5">
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground">
                  Configure the concrete workspace Agilo attaches to this project. These values drive per-workspace
            ...
            <div className="mt-4 grid gap-4">
              ...
              <Field label="Runtime services JSON" hint="Default runtime services for this workspace. Execution workspaces inherit this config unless they set an override. If you do not know the commands yet, ask your Orchestrator to configure them for you.">
                <textarea
