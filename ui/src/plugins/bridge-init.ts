 ...
 *
 * This is placed on `globalThis.__agiloPluginBridge__` and consumed by
...
declare global {
  ...
  var __agiloPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__agiloPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__agiloPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
