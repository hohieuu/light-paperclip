/**
 * esbuild configuration for building the agilo CLI for npm.
 *
 * Bundles all workspace packages (@agilo/*) into a single file.
...
// to npm and resolved at runtime (e.g. @agilo/server uses dynamic import).
