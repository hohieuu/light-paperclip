...
This document covers the GitHub and npm setup required for the current Agilo release model:
...
Do this for every public package that Agilo publishes.
...
3. add a trusted publisher for the GitHub repository `agilo/agilo`
...
2. revoke any personal automation token that used to publish Agilo
