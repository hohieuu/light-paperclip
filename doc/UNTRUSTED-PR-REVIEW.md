...
This is intentionally separate from the normal Agilo dev image.
...
```sh
review-checkout-pr agilo/agilo 432
cd /work/checkouts/agilo-agilo/pr-432
```
...
## Preview the Agilo app from the PR
...
- Agilo's embedded PostgreSQL and local storage stay inside the container home volume via `AGILO_HOME=/home/reviewer/.agilo-review`.
