...
- installed adapter list for this Agilo instance
...
## 8. New Skill: `agilo-create-agent`

Create new skill directory:

- `skills/agilo-create-agent/SKILL.md`
...
Also update `skills/agilo/SKILL.md` to reference this skill for hiring workflows.
...
- `agilo-create-agent` skill + docs updates
